...
export const getResourceType = (tableName: string): ResourceType => {
  const resourceType = {
    ...
    OBSERVATION_BODYHEIGHT: ResourceType.OBSERVATION,
    OBSERVATION_BODYWEIGHT: ResourceType.OBSERVATION,
    OBSERVATION_HEADCIRCUMFERENCE: ResourceType.OBSERVATION,
...
export const getExportTableLabel = (tableName: string) => {
  const tableLabel = {
    ...
    observation_bodyheight: 'Fait - Croissance pédiatrique - Taille',
    observation_bodyweight: 'Fait - Croissance pédiatrique - Poids',
    observation_headcircumference: 'Fait - Croissance pédiatrique - Périmètre crânien',
