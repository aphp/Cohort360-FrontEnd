...
export const getReferences = (config: Readonly<AppConfig>) => [
  {
    ...
    loadingMode: config.features.medication.valueSets.medicationAtc.loadingMode ?? 'expand',
    checked: true,
  ...
  },
  {
    ...
    loadingMode: config.features.medication.valueSets.medicationUcd.loadingMode ?? 'list',
    checked: true,
    joinDisplayWithCode: true,
    joinDisplayWithSystem: true,
    filterRoots: () => true
  },
  {
    ...
    loadingMode: config.features.observation.valueSets.biologyHierarchyAnabio.loadingMode ?? 'expand',
    checked: true,
  ...
  },
  {
    ...
    loadingMode: config.features.observation.valueSets.biologyHierarchyLoinc.loadingMode ?? 'list',
    checked: true,
    joinDisplayWithCode: true,
    joinDisplayWithSystem: true,
    filterRoots: () => true
  },
  {
    ...
    loadingMode: config.features.procedure.valueSets.procedureHierarchy.loadingMode ?? 'expand',
    checked: true,
    joinDisplayWithCode: true,
  ...
  },
  {
    ...
    loadingMode: config.features.condition.valueSets.conditionHierarchy.loadingMode ?? 'expand',
    checked: true,
    joinDisplayWithSystem: false,
    joinDisplayWithCode: true,
    filterRoots: () => true
  },
  {
    ...
    loadingMode: config.features.claim.valueSets.claimHierarchy.loadingMode ?? 'expand',
    checked: true,
    joinDisplayWithCode: true,
    joinDisplayWithSystem: false,
    filterRoots: () => true
