...
import { Filters, SearchByTypes, SearchCriterias, searchByListPatients } from 'types/searchCriterias'
import Select from 'components/ui/Searchbar/Select'
import SearchInput from 'components/ui/Searchbar/SearchInput'
import { Controller, useForm } from 'react-hook-form'
import { Search } from '../useExplorationBoard'
...
const OccurrencesSearch = ({ search, onChange }: OccurrencesSearchProps) => {
            ...
            <Controller
              ...
              render={({ field }) =>
                field.value !== undefined ? (
                  <SearchInput value={field.value} radius={5} placeholder="Rechercher" onchange={field.onChange} />
                ) : (
                  <Fragment />
                )
              }
