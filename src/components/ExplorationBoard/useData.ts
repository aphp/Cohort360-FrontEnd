...
import { CohortMedication, CohortPMSI, CohortResults, LoadingStatus } from 'types'
...
export type Data =
  | PatientsResponse
  | CohortResults<CohortPMSI | CohortMedication<MedicationRequest | MedicationAdministration>>
