    ...
    <Grid className={classes.root}>
      ...
      <Grid className={classes.formContainer}>
        ...
        <Alert severity="warning">
          ...
          plus utilisés au niveau national et à l'AP-HP. De plus, les résultats concernent uniquement les analyses
          quantitatives enregistrées sur GLIMS qui ont été créés et mises à jours depuis mars 2020.
        </Alert>
