  ...
  return (
    <>
      ...
      <Typography color="textSecondary" style={{ paddingBottom: 8, paddingLeft: 16 }}>
        • <b>La liste d'IPP</b> à été rajoutée à la liste de critère dans le requêteur.
      </Typography>
      <Typography color="textSecondary" style={{ paddingBottom: 8, paddingLeft: 16 }}>
      ...
      <Typography color="textSecondary" style={{ paddingBottom: 8, paddingLeft: 16 }}>
        • Diverses corrections ont été apportées <b>aux filtres</b> ainsi que sur <b>les tris</b>.
      </Typography>
