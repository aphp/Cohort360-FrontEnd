...
const FavResearch = ({ simplified, onClickRow, filteredIds }) => {
  ...
  React.useEffect(() => {
    fetchFavoriteCohorts().then(({ formattedCohort }) => {
      setResearches(formattedCohort)
    })
  }, [])
  ...
  return (
    <React.Fragment>
      <Grid container spacing={3}>
        <Grid item xs={9}>
          <Title>Mes cohortes favorites</Title>
        </Grid>
