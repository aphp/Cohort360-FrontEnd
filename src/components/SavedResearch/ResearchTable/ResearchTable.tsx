              ...
              <TableHead>
                <TableRow className={classes.tableHead}>
                  ...
                  <TableCell className={classes.tableHeadCell} align="center">
                    ...
                    <Tooltip title="Cet intervalle correspond à une estimation du nombre de patients correspondant aux critères de votre requête avec comme population source tous les hopitaux de l'APHP">
