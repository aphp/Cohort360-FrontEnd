...
export const form: () => CriteriaForm<ImagingDataType> = () => ({
  ...
  initialData: {
    ...
    studyDescription: '',
    studyProcedure: '',
    numberOfSeries: { value: 0, comparator: Comparators.GREATER_OR_EQUAL },
    numberOfIns: { value: 0, comparator: Comparators.GREATER_OR_EQUAL },
      ...
      items: [
        ...
        },
        {
          ...
          displayCondition: (data) =>
            ((data as ImagingDataType).withDocument as LabelObject[])?.at(0)?.id === 'INFERENCE_TEMPOREL'
        },
        {
          valueKey: 'studyUid',
          type: 'textWithRegex',
