 ...
 */
export const getHierarchySelection = (row: any, selectedItems: any[] | undefined, rootRows: any[]) => {
...
export const optimizeHierarchySelection = (selectedItems: any[], rootRows: any[]) => {
