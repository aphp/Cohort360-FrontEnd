  ...
  const login = async () => {
    try {
      localStorage.setItem(
        ACCES_TOKEN,
        'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjEyMzA1NTc4LCJqdGkiOiJlYWE5YTM3YmM0ZTI0YTI1OGZlYzgxYjg0NDc1OTQ4OSIsInVzZXJuYW'
      )
      localStorage.setItem(
        REFRESH_TOKEN,
        'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoicmVmcmVzaCIsImV4cCI6MTYxMjMwNTU3OCwianRpIjoiMmM'
      )
