...
sed -i "s@{REACT_APP_VALUE_SET_URL_BIOLOGY_HIERARCHY_ITM_ANABIO}@$REACT_APP_VALUE_SET_URL_BIOLOGY_HIERARCHY_ITM_ANABIO@g" /app/build/static/js/*.js
sed -i "s@{REACT_APP_VALUE_SET_URL_BIOLOGY_HIERARCHY_ITM_LOINC}@$REACT_APP_VALUE_SET_URL_BIOLOGY_HIERARCHY_ITM_LOINC@g" /app/build/static/js/*.js
