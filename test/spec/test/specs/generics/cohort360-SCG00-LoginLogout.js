...
describe('Cohort360 - SC00 - Connexion / Déconnexion', () => {
  ...
  it("Accès à la page d'authentification", async () => {
    ...
    expect(await browser.getUrl())
      .withContext("@ L'URL de la page d'authentification doit être : " + LoginPage.getUrl())
      .toBe(LoginPage.getUrl())

    Logger.log("Vérification de la présence du formulaire d'authentification")
    expect((await LoginPage.loginField.isDisplayed()) && (await LoginPage.passwordField.isDisplayed()))
      .withContext('@ Affichage des input "Identifiant" & "Votre mot de passe" du formulaire')
      .toBe(true)
  })
  ...
  //     expect(await LoginPage.legalNoticeBlock.link.isDisplayed())
  //       .withContext('@ Le lien est affiché')
  //       .toBe(true)

  //     Logger.log('Le lien est clickable')
  //     expect(await LoginPage.legalNoticeBlock.link.isClickable())
  //       .withContext('@ Le lien est clickable')
  //       .toBe(true)
  //   })
  ...
  //     expect(await LoginPage.modalBox.box.waitForDisplayed())
  //       .withContext('@ Affichage de la fenêtre modale')
  //       .toBe(true)

  //     Logger.log('Affichage du contenu de la mention légale')
  //     expect(await LoginPage.modalBox.boxContent.isDisplayed())
  //       .withContext('@ Affichage du contenu de la mention légale')
  //       .toBe(true)
  //     expect(await LoginPage.modalBox.boxContent.$$('p')[0].getText())
  //       .withContext('@ Mention légale P1')
  //       .toBe(LoginPage.legalNoticeBlock.p1Value)
  //     expect(await LoginPage.modalBox.boxContent.$$('p')[1].getText())
  //       .withContext('@ Mention légale P2')
  //       .toBe(LoginPage.legalNoticeBlock.p2Value)
  //     expect(await LoginPage.modalBox.boxContent.$$('p')[2].getText())
  //       .withContext('@ Mention légale P3')
  //       .toBe(LoginPage.legalNoticeBlock.p3Value)

  //     Logger.log('Le bouton de fermeture est clickable')
  //     var OkButton = await LoginPage.modalBox.okButton
  //     expect(await OkButton.isClickable())
  //       .withContext('@ Le bouton de fermeture est clickable')
  //       .toBe(true)
  ...
  //     expect(await LoginPage.invalidCredentialsErrorMessage.isDisplayed())
  //       .withContext("@ Le message d'erreur est présent")
  //       .toBe(true)

  //     Logger.log('Le bouton OK est clickable')
  //     expect(await LoginPage.modalBox.okButton.isClickable())
  //       .withContext('@ Le bouton OK est clickable')
  //       .toBe(true)
  ...
  //     expect(await HomePage.welcomeMessage.waitForDisplayed())
  //       .withContext('@ Le message de bienvenue est affiché')
  //       .toBe(true)

  //     Logger.log("L'URL de la page d'accueil doit être : " + HomePage.getUrl())
  //     expect(await browser.getUrl())
  //       .withContext("@ L'URL de la page d'accueil doit être : " + HomePage.getUrl())
